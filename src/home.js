...
class Home extends Component {
  render() {
    return (
      <div className="text-black" id="section_1">
        ...
        <p>
          ...
          massa. Sticky Heading 4 Quisque cursus, metus vitae pharetra auctor,
          sem massa mattis sem, at interdum magna augue eget diam. Vestibulum
          ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia
          Curae; Morbi lacinia molestie dui. Praesent blandit dolor. Sed non
          quam. In vel mi sit amet augue congue elementum. Morbi in ipsum sit
          ...
          est pulvinar ullamcorper. Nulla facilisi. Sticky Heading 5 Integer
          ...
          id, sagittis at, neque. Sticky Heading 6 Nullam mauris orci, aliquet
